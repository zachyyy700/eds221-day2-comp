...
## Logical vectors
```{r}
x[c(TRUE, FALSE, TRUE, TRUE, TRUE,TRUE, FALSE, TRUE, TRUE, TRUE)]
x[x >3]
```

## Subsetting & assigning multiple values
```{r}
x <- 1:5
x[c(1,2)] <- 2:3
...
## Subset rows in df on conditions (logical subsetting)
